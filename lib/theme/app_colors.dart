...
// ============================================================
//  AppColors — More Than Fitness 색상 시스템
...
class AppColors {
  ...
  static Color lessonBlockColor(String typeName, {String? colorHex}) {
    ...
    switch (typeName.trim()) {
      case 'PT수업': case 'PT':          return lessonPt;
      case '필라테스':                    return lessonPilates;
      case '그룹수업': case '그룹':       return lessonGroup;
      case 'OT상담': case '상담': case 'OT': return lessonOt;
      case '재활수업': case '재활':       return lessonRehab;
      default:                           return lessonPt;
    }
  }
  ...
  static Color lessonChipBg(String typeName, {String? colorHex}) {
    ...
    switch (typeName.trim()) {
      case 'PT수업': case 'PT':          return lessonPtLight;
      case '필라테스':                    return lessonPilatesLight;
      case '그룹수업': case '그룹':       return lessonGroupLight;
      case 'OT상담': case '상담': case 'OT': return lessonOtLight;
      case '재활수업': case '재활':       return lessonRehabLight;
      default:                           return lessonPtLight;
    }
  }
  ...
  static Color lessonChipText(String typeName, {String? colorHex}) {
    ...
    switch (typeName.trim()) {
      case 'PT수업': case 'PT':          return lessonPtText;
      case '필라테스':                    return lessonPilatesText;
      case '그룹수업': case '그룹':       return lessonGroupText;
      case 'OT상담': case '상담': case 'OT': return lessonOtText;
      case '재활수업': case '재활':       return lessonRehabText;
      default:                           return lessonPtText;
    }
  }
  ...
  return ThemeData(
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(10),
        borderSide: const BorderSide(color: AppColors.lightGradientStart, width: 1.5),
      ),
...
ThemeData darkTheme() {
  ...
  return ThemeData(
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      hintStyle: const TextStyle(color: AppColors.darkTextTertiary, fontSize: 12),
